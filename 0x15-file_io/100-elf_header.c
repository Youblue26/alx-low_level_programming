 ...
 * @e_ident: points an array containing ELF magic numbers.
 *
 ...
 * @e_ident: points to an array containing ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 * @e_ident: points to array containing ELF ABI version.
 */
void print_abi(unsigned char *e_ident)

int main(void)
{
	unsigned char  e_ident[] = {'E', 'L', 'F', '2', '1'}
 ...
 * @argv: array of points to the arguments.
 *
 * Return: 0 on success.
 *
